...
// Dependancy
  ...
  Stream<CardState> mapEventToState(CardEvent event) async* {
    ...
    } else if (event is AddBatchCards) {
      yield* _mapAddBatchCardsToState(event);
  ...
  Stream<CardState> _mapAddBatchCardsToState(AddBatchCards event) async* {
    databaseRepository.addBatchCards(event.card);
  }
