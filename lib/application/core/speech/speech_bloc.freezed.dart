...
mixin _$SpeechState {
  ...
  @optionalTypeArgs
  Result when<Result extends Object>({
    @required Result initial(SpeechEntity speechEntity),
    @required Result isListening(SpeechEntity speechEntity),
  });
  @optionalTypeArgs
  Result maybeWhen<Result extends Object>({
    Result initial(SpeechEntity speechEntity),
    Result isListening(SpeechEntity speechEntity),
    @required Result orElse(),
  });
  @optionalTypeArgs
  Result map<Result extends Object>({
    @required Result initial(_Initial value),
    @required Result isListening(_IsListening value),
  });
  @optionalTypeArgs
  Result maybeMap<Result extends Object>({
    Result initial(_Initial value),
    Result isListening(_IsListening value),
    @required Result orElse(),
  });
